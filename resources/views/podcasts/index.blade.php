    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <div>
                    <a href="{{ route('podcasts.create') }}" class="btn btn-primary">Add Podcast</a>
                    <div id="headingOne"
            ...
            <form action="{{ route('podcasts.index') }}" method="GET">
                <div id="collapseOne"
...
{{--                        </div>--}}
                    ...
                    <a href="{{route('podcasts.index')}}" class="btn btn-primary w-20">Clear Filter</a>
                </div>
            </form>
                        ...
                        <tbody>
                            @forelse($podcasts as $podcast)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('users.show', ['user' => $podcast->user->id]) }}">
                                            {{ $podcast->user->name }}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="px-3">
                                        <a href="{{ route('comments.index', ['type' => 'podcast', 'id' => $podcast->id]) }}">
                                            {{ $podcast->comments_count }}
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('podcasts.edit', ['podcast' => $podcast->id]) }}" class="dropdown-item">Edit</a>
                                                <a class="dropdown-item delete-podcast" data-delete-podcast="{{ $podcast->id }}">Delete</a>
...
@push('scripts')
    ...
    <script>
        $(document).on('click', '.delete-podcast', function (e) {
            e.preventDefault();
            let podcast_id = $(this).data('deletePodcast');
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status == 404) {
                                toastr.error(response.message, "Podcast", {
