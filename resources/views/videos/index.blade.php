...
{{--                        </div>--}}
                    ...
                    <a href="{{route('videos.index')}}" class="btn btn-primary w-20">Clear Filter</a>
                </div>
            </form>
                        ...
                        <tbody>
                            @forelse($videos as $video)
                                <tr>
                                    ...
                                    <td class="px-3">
                                        <a href="{{ route('comments.index', ['type' => 'video', 'id' => $video->id]) }}">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('videos.edit', ['video' => $video->id]) }}" class="dropdown-item">Edit</a>
                                                <a class="dropdown-item delete-video" data-delete-video="{{ $video->id }}">Delete</a>
...
@push('scripts')
    ...
    <script>
        $(document).on('click', '.delete-video', function (e) {
            e.preventDefault();
            let video_id = $(this).data('deleteVideo');
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status == 404) {
                                toastr.error(response.message, "Video", {
